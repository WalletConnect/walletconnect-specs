...
<Container
  items={[
    ...
    },
    {
      name: "Notify API",
      description:
        "Notify is a push notification protocol that enables apps to notify users of both off-chain and on-chain events.",
...
<Container
  items={[
    ...
    {
      name: "Blockchain API",
      description: "Blockchain API is used for interacting with different blockchains, resolving identity, ENS interactions and transactions history.",
      url: `/2.0/specs/servers/blockchain`
    }
  ]}
/>
